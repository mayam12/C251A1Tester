public class main {
  public static void main(String[] args) {
    ...
    /**
     * Test if you can insert into chaining table when there are no elements in the bucket
     */
    ...
    /**
     * Test if you can insert into chaining table when there are
     * elements in the bucket and value that exceed the elements in the bucket
     */
